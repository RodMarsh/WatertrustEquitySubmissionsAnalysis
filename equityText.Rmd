...
```{r}
# Sentiment analysis on the concordance vs the overall corpus - NOT YET COMPLETE

mdba_concordance_dfm <- dfm(mdba_concordance)

# Getting the tokens that are not in the KWIC
non_kwic_tokens <- tokens_remove(tokens, pattern = pattern_string, valuetype = "regex", case_insensitive = TRUE)
dfm_non_kwic <- dfm(non_kwic_tokens)
