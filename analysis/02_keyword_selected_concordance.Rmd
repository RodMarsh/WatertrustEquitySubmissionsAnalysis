...
plot_groupwise_rel_freqs <- function (args) {
  ...
  small_multi <-
    ...
    filename <- paste(c("../results/group_comparison", highlight_group, keywords[1], ".pdf"), collapse="_")
    print(filename)
    ggsave(filename, plot = small_multi, width=180/25.4, height=(length(keywords)*8/25.4) + 40/25.4)
  return(small_multi)
}
...
groups_to_visualise <- list(
  list('commercialnon', c("opaque", "scarcity")),
  list('commercialnon', c("clients", "intermediaries", "participants")),
  list('commercialnon', c("bids",
    ...
    "ivt",
    "liquidity")),
  list('consumptive', c("family", "farmer", "farming")),
  list('consumptive', c("barley", "cereals", "planted")),
  list('consumptive', c("dairy", "cattle", "livestock")),
  list('consumptive', c("feral")),
  list('consumptive', c("450gl", "650gl", "ml")),
  list('consumptive', c("permanent", "temporary", "entitlement", "carryover")),
  list('consumptive', c("choke", "valley", "valleys")),
  list('consumptive', c("speculators", "traders")),
  list('electedrep', c("overallocation")),
  list('electedrep', c("1,500", "2,750", "450", "gigalitres")),
  list('resourcemanagers', c("greening", "amenity", "livability")),
  list('resourcemanagers', c("covid", "pandemic")),
  list('resourcemanagers', c("utilities", "wastewater", "stormwater", "potable")),
  list('resourcemanagers', c("customer", "customers")),
  list('regional', c("390gl", "320gl")),
  list('regional', c("resident", "lived", "lga", "km2")),
  list('regional', c("equitable", "greedy", "wellbeing")),
  list('regional', c("yabbies", "revegetation")),
  list('regional', c("councils", "interagency", "referenced", "website")),
  list('regional', c("tourism")),
  # Research
  list('research', c("biology", "biota", "bodied", "decentralised", "linear", 
                     "landsat", "mortality", "scales", "sensing", "stressors")),
  # First Nations
  list('firstnations', c("colonisation", "dispossessed", "neoliberal", "nullius")),
  list('firstnations', c("aboriginal", "indigenous", "lands", "peoples")),
  list('firstnations', c("nban", "mldrin")),
  list('firstnations', c("kon", "undrip", "title")),
  list('firstnations', c("cultural", "spiritual", "traditions", "sacred", "customs")),
  list('firstnations', c("foods", "hunting", "medicine")),
  # Government
  ...
  # Research
  list('research', c("journal", "australasian")),
  list('research', c("decentralised", "scales", "linear")),
  list('research', c("mortality", "stressors", "biota")),
  list('research', c("sensing", "landsat")),
  # Environmental
  list('environmental', c("migratory", "ramsar")),
