...
plot_groupwise_rel_freqs <- function (args) {
  ...
  small_multi <-
    ...
    theme_minimal() +
    theme(panel.spacing.x=unit(0.2, "cm"), panel.spacing.y=unit(0.2, "cm")) +
    scale_y_continuous(name="% of Submissions", position="right") +
    ...
    ggsave(filename, plot = small_multi, width=180/25.4, height=(length(keywords)*20/25.4) + 40/25.4)
  return(small_multi)
}
...
groups_to_visualise <- list(
  list('commercialnon', c("opaque")),
  list('commercialnon', c("scarcity")),
  list('commercialnon', c("brokers", "clients", "intermediaries", "participants")),
  list('consumptive', c("family", "farmer", "farming")),
  list('consumptive', c("farmers", "growers")),
  list('consumptive', c("acres", "barley", "cereals", "planted")),
  list('consumptive', c("dairy", "cattle", "pasture")),
  ...
  list('electedrep', c("1,500", "2,750", "450", "gigalitre", "gigalitres")),
  ...
  list('regional', c("resident")),
  list('regional', c("equitable", "greedy", "wellbeing")),
  list('regional', c("yabbies", "revegetation", "tourism")),
  # First Nations
  list('firstnations', c("cultural", "spiritual")),
  list('firstnations', c("foods")),
  # Government
  list('government', c("undergone", "undertaken", "undertakes", "undertook", "underway")),
  # Research
  # Environmental
